...
function RequestJson({ dataRequest, url, urlGateway, label, textButton, type, ...rest }) {
  ...
  return (
    <Container {...rest}>
      <ContainerRow style={{ alignItems: 'center', paddingTop: 10, marginBottom: 10 }}>
        ...
        {type === 'url' && (
          <ContainerFlexWidth widthPercent={50} style={{ marginLeft: 20, maxWidth: 140 }}>
            <Button
      ...
      {dataRequest && <JSONPretty id="json-pretty" data={{ ...dataRequest, url }} />}
